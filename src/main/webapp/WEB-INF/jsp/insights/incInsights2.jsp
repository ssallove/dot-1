                    ...
                    <h3>Syrup 의 신규 가입 고객은 점차적으로 줄어 드는 추세에 있어, 신규 가입을 올리기 위한 Lead Generation 필요!<br>
                        ...
                        <div class="layoutLR">
                            <li class=" floatL boxSty" style="width:100%;height:270px !important;min-height:270px !important; ">
                                <p class="chart" id="insights2_chart_0" style="min-height:260px !important;">Chart Area</p>
                            </li>
                            <li class=" floatL boxSty" style="width:100%;height:270px !important;min-height:270px !important; ">
                                <p class="chart" id="insights2_chart_1" style="min-height:260px !important;">Chart Area</p>
                            </li>
                        </div>
                </div>
                <!--//내용1-->
                    ...
                    <h3>경제 활동 대비 Syrup의 Penetration은 21% 이며, <br>
                        ...
                        <div class="layoutLR">
                            <li class=" floatL boxSty newsCbox" style="width:60%">
                                <p class="chart" id="insights2_chart_2" style="height:418px">Chart Area</p>
                            </li>
                    ...
                    <div class="newsCbox">
                        <div class="layoutLR">
                            <li class=" floatL boxSty" style="width:56%">
                                <p class="chart" id="insights2_chart_3">Chart Area</p>
                            </li>
                            ...
                            <li class=" floatL boxSty" style="width:38%">
                                <p class="chart" id="insights2_chart_4">Chart Area</p>
                            </li>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="newsCbox">
                        <div class="layoutLR">
                            <li class=" floatL boxSty" style="width:100%">
                                <p class="chart" id="insights2_chart_5">Chart Area</p>
                            </li>
                        </div>
                    </div>
                </div>
