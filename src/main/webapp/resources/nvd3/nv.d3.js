...
nv.models.indentedTree = function() {
    ...
    selection.each(function(data) {
      ...
      if (align) {
        ...
        series.each(function(d,i) {
              ...
              seriesWidths.push(nodeTextLength + gap); // 28 is ~ the width of the circle plus some padding
            });
  ...
  chart.isMultiChart = function(_) {
    if (!arguments.length) return isMultiChart;
    isMultiChart = _;
    return chart;
  };
...
/*            var indexToHighlight = nv.nearestValueIndex(allData.map(function(d){return d.value}),yValue,threshold);
  ...
  chart.topLegend = function(_) {
    if (!arguments.length) return topLegend;
    topLegend = _;
    return chart;
  };
  
  chart.topLegendHeight = function(_) {
    if (!arguments.length) return topLegendHeight;
    topLegendHeight = _;
    return chart;
  };
  
  chart.legendGap = function(_) {
    if (!arguments.length) return legendGap;
    legendGap = _;
    return chart;
  };  

  chart.showNoData = function(_) {
    if (!arguments.length) return showNoData;
    showNoData = _;
    return chart;
  };  
  //============================================================
