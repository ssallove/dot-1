...
<div class="modal fade" id="myModal7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal_body2">
                ...
                <div class="news mt10">
                    ...
                    <div class="layoutLR mb0">
                        <li class=" floatL boxSty newsCbox" style="width:49%;">
                            <p class="chart" id="insights7_chart_0"></p>
                        </li>
                        <li class=" floatR boxSty newsCbox" style="width:49%">
                            <p class="chart" id="insights7_chart_1"></p>
                        </li>
                    </div>
                ...
                <h3>상품 Pareto분석을 통해 매출상위상품의 매출기여도를 살펴보면 상위 1%인 13만개 상품이 전체 매출의 55% 인 2,058억원 기여<br/>
                        ...
                        <div class="layoutLR newsCbox">
                            ...
                            <p class="chart" id="insights7_chart_2"></p>
                        </li>
                        </div>
                </div>
                <!--//내용3-->
                ...
                <h3>2015년 7월의 카테고리별 상품 Pareto를 살펴보면 상위 1%상품의 매출비중이 <br/>
                    ...
                    <div class="newsCbox">
                        <div class="layoutLR">
                            <li class=" floatL boxSty" style="width:100%">
                                <p class="chart" id="insights7_chart_3" style="height:468px"></p>
                            </li>
                        </div>
                    </div>
                </div>
 ...
 var incInsights7 = {
		 showInsight : function(){
			 var charts=[];
			 var myChart = echarts.init($('#insights7_chart_0')[0], GV_CHART_THEME);  this.drawChart0(myChart);   charts.push(myChart);
			 myChart = echarts.init($('#insights7_chart_1')[0], GV_CHART_THEME);  this.drawChart1(myChart);   charts.push(myChart);
			 myChart = echarts.init($('#insights7_chart_2')[0], GV_CHART_THEME);  this.drawChart2(myChart);   charts.push(myChart);
			 myChart = echarts.init($('#insights7_chart_3')[0], GV_CHART_THEME);  this.drawChart3(myChart);   charts.push(myChart);
		 ...
		 drawChart0 : function(myChart){
			 ...
			 var option = {
			            ...
			            tooltip : {
			                ...
			                formatter : incInsights7.cvtformat_val
			            },
			            grid:{y:105, y2:20},
			            legend: {
				            y : 40
